    ...
    return (
        <div className="border  relative group overflow-hidden rounded-md  ">
            <div className="relative z-10 space-y-4 px-4 py-2  group-hover:text-white transition-all duration-700">
                <Icon className="w-5 h-5 text-violet-500 group-hover:mix-blend-difference duration-1000 " />
            ...
            <Icon className="w-28 h-28 translate-x-[50%] -translate-y-[30%]  absolute z-10 top-0 right-0 text-slate-200 opacity-80 transition-all duration-500 group-hover:rotate-[25deg]  " />
